...
// const map = Deno.readTextFileSync("./example1"); //2
// const map = Deno.readTextFileSync("./example2"); // 4
// const map = Deno.readTextFileSync("./example3"); // 3
// const map = Deno.readTextFileSync("./sample"); // 36
