...
//     let directions: Vec<(Option<Position>, Grid)> = Vec::from([
//         // move_direction(Direction::Right, &start, &path_grid, &grid),
//         // move_direction(Direction::Left, &start, &path_grid, &grid),
//         // move_direction(Direction::Up, &start, &path_grid, &grid),
//         // move_direction(Direction::Down, &start, &path_grid, &grid),
//     ]);
